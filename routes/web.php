...
Route::get('/catalog/variations/{productId}',[ProductController::class,'variations'])->name('variations.show');
...
Route::get('react/whishlist/items', [WishlistController::class, 'show'])->name('whishlist.items');
...
Route::post('/add-to-wishlist/{product_id}/{user_id}', [WishlistController::class, 'store']);
